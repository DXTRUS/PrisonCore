...
/**
 * <b>Note:</b><br>
 * I do not know who the author of this file is. If someone knows, please fucking tell me via ljones@dxtrus.net
 *
 * @author unknown
 */
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public World getWorld() {
        ...
        if (world == null) {
            throw new IllegalStateException("world '" + worldName + "' is not loaded or doesnt exist");
        }
        return world;
    }
    ...
    public Cuboid expand(CuboidDirection dir, int amount) {
        return switch (dir) {
            ...
            default -> {
                LogUtil.warn("Unknown cuboid expansion direction: " + dir);
                yield this;
            }
        };
    }
    ...
    public Cuboid outset(CuboidDirection dir, int amount) {
        ...
        switch (dir) {
            ...
            case Both:
                ...
                break;
            default:
                Bukkit.getLogger().warning("Unknown cuboid expansion direction: " + dir);
                return this;
        }
        return c;
    }
